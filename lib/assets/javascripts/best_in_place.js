...
BestInPlaceEditor.prototype = {
    ...
    update: function () {
        ...
        if (this.warning_before_save && (!this.warning_before_save_with_new_values || (value in this.warning_before_save_with_new_values)) && !confirm(this.warning_before_save)) {
            this.abort();
            return true;
        }
